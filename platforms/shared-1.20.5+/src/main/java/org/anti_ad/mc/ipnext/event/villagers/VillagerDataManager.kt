...
object VillagerDataManager {
    ...
    private fun addProfessionToAllGroups(professionId: String) {
        config.globalBookmarks[professionId] = mutableListOf()
        config.globalBookmarks1[professionId] = mutableListOf()
        config.globalBookmarks2[professionId] = mutableListOf()
    }

    private fun createInitialFile() {
        addProfessionToAllGroups(VillagerProfession.ARMORER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.BUTCHER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.CARTOGRAPHER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.CLERIC.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.FARMER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.FISHERMAN.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.FLETCHER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.LEATHERWORKER.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.LIBRARIAN.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.MASON.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.SHEPHERD.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.TOOLSMITH.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.WEAPONSMITH.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.NITWIT.`(professionId)`)
        addProfessionToAllGroups(VillagerProfession.NONE.`(professionId)`)
        config.markDirty()
        saveIfDirty()
    }
