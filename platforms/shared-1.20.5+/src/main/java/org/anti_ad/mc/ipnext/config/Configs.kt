...
object ModSettings : ConfigDeclaration {
    ...
    val HIGHLIGHT_FOUSED_ITEMS                    /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val HIGHLIGHT_FOUSED_ITEMS_ANIMATED           /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)
...
*/
    ...
    val ENABLE_PROFILES                          /**/ by keyToggleBool(ConfigScreenSettings, true)
        .CATEGORY("§§hide")
    val PROFILES_PER_SERVER                      /**/ by bool(true)

        .CATEGORY("$category.lock_slots")
    val ENABLE_LOCK_SLOTS                         /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val ENABLE_LOCK_SLOTS_PER_SERVER              /**/ by bool(true)


        .CATEGORY("$category.auto_refill")
    val ENABLE_AUTO_REFILL                        /**/ by keyToggleBool(ConfigScreenSettings, true)

        .CATEGORY("$category.villager_trading")
        //.CATEGORY("§§hide")
    val VILLAGER_TRADING_ENABLE                   /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val VILLAGER_TRADING_GROUP_1                  /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)
    val VILLAGER_TRADING_GROUP_2                  /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)
    ...
    val ADD_INTERVAL_BETWEEN_CLICKS               /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)
    ...
    val RESTOCK_HOTBAR                            /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)
...
object AutoRefillSettings : ConfigDeclaration {
    ...
    val DISABLE_FOR_DROP_ITEM                     /**/ by keyToggleBool(ConfigScreenSettings, false)
    val IGNORE_LOCKED_SLOTS                       /**/ by bool(true)
    val AUTO_REFILL_PREFER_SMALLER_STACKS         /**/ by bool(false)
    val REFILL_ARMOR                              /**/ by keyToggleBool(ConfigScreenSettings, true)
    val REFILL_BEFORE_TOOL_BREAK                  /**/ by keyToggleBool(ConfigScreenSettings, true)
    ...
    val AUTO_REFILL_ENABLE_PER_SLOT_CONFIG        /**/ by keyToggleBool(ConfigScreenSettings, true)
    val AUTO_REFILL_ENABLE_INDICATOR_ICONS        /**/ by keyToggleBool(ConfigScreenSettings, true)
    val AUTO_REFILL_ENABLE_HORBAR_INDICATOR_ICONS /**/ by keyToggleBool(ConfigScreenSettings, true)
    ...
    val ALLOW_BREAK_FOR_NON_ENCHANTED             /**/ by keyToggleBool(ConfigScreenSettings, false)
    val TOOL_MAX_DURABILITY_THRESHOLD             /**/ by int(500,
                                                              0,
                                                              5000)
        .CATEGORY("$category.auto-refill.notifications")
    val ALLOW_ALERTS_WITHOUT_TOOL_PROTECTION      /**/ by keyToggleBool(ConfigScreenSettings, false)
    val VISUAL_DURABILITY_NOTIFICATION            /**/ by keyToggleBool(ConfigScreenSettings, true)
    val TYPE_VISUAL_DURABILITY_NOTIFICATION       /**/ by enum(ToolReplaceVisualNotification.HOTBAR)
    val AUDIO_DURABILITY_NOTIFICATION             /**/ by keyToggleBool(ConfigScreenSettings, true)
    ...
    val NOTIFICATION_STEP                         /**/ by int(5,
                                                              1,
                                                              5)
    val VISUAL_REPLACE_SUCCESS_NOTIFICATION       /**/ by keyToggleBool(ConfigScreenSettings, true)
    val AUDIO_REPLACE_SUCCESS_NOTIFICATION        /**/ by keyToggleBool(ConfigScreenSettings, true)
    val TYPE_VISUAL_REPLACE_SUCCESS_NOTIFICATION  /**/ by enum(ToolReplaceVisualNotification.HOTBAR)
    val VISUAL_REPLACE_FAILED_NOTIFICATION        /**/ by keyToggleBool(ConfigScreenSettings, true)
    val AUDIO_REPLACE_FAILED_NOTIFICATION         /**/ by keyToggleBool(ConfigScreenSettings, true)
...
object LockedSlotsSettings : ConfigDeclaration {
    ...
    val LOCK_SLOTS_DISABLE_USER_INTERACTION             /**/ by keyToggleBool(ConfigScreenSettings, false, KeybindSettings.GUI_DEFAULT)

        .CATEGORY("$category.lock_slots.empty")
    val LOCKED_SLOTS_ALLOW_PICKUP_INTO_EMPTY            /**/ by keyToggleBool(ConfigScreenSettings, false)
    val LOCKED_SLOTS_DELAY_KEEPER_REINIT_TICKS          /**/ by int(50,
                                                                    20,
                                                                    400)
    val LOCKED_SLOTS_EMPTY_HOTBAR_AS_SEMI_LOCKED        /**/ by keyToggleBool(ConfigScreenSettings, false)
    ...
    val SHOW_LOCKED_SLOTS_BACKGROUND              /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val SHOW_LOCKED_SLOTS_FOREGROUND              /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val ALSO_SHOW_LOCKED_SLOTS_IN_HOTBAR          /**/ by keyToggleBool(ConfigScreenSettings, true)
...
object GuiSettings : ConfigDeclaration {
    ...
    val INVENTORY_OVERLAY_BUTTONS_VISIBLE         /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val ENABLE_INVENTORY_EDITOR_BUTTON            /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val ENABLE_INVENTORY_SETTINGS_BUTTON          /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
        .CATEGORY("$category.profiles")
    val ENABLE_PROFILES_UI                        /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val ENABLE_PROFILES_ANNOUNCEMENT              /**/ by bool(true)
        .CATEGORY("$category.inventory")
    val ENABLE_INVENTORY_BUTTONS                  /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    val SHOW_BUTTONS_BOTH_SIDES                   /**/ by bool(false)

    val SHOW_FAST_RENAME_CHECKBOX                 /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val SHOW_CONTINUOUS_CRAFTING_CHECKBOX         /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val SHOW_REGULAR_SORT_BUTTON                  /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val SHOW_SORT_IN_COLUMNS_BUTTON               /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val SHOW_SORT_IN_ROWS_BUTTON                  /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
    ...
    val SHOW_MOVE_ALL_BUTTON                      /**/ by keyToggleBool(ConfigScreenSettings, true, KeybindSettings.GUI_DEFAULT)
...
object Tweaks : ConfigDeclaration {
    override val builder = createBuilder()
        ...
        .CATEGORY("§§vgap:-5")
        .CATEGORY("$category.inventory")
    val PREVENT_CLOSE_GUI_DROP_ITEM               /**/ by keyToggleBool(ConfigScreenSettings, false)
    val CONTAINER_SWIPE_MOVING_ITEMS              /**/ by keyToggleBool(ConfigScreenSettings, true)
    val SWIPE_MOVE_CRAFTING_RESULT_SLOT           /**/ by keyToggleBool(ConfigScreenSettings, false)
