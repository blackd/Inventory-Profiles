...
val supported_minecraft_versions = mapOf(MODRINTH to listOf("1.21.1"),
                                         CURSEFORGE to listOf("1.21.1"))
...
val fabric_api_version = "0.114.0+1.21.1"
...
val controlify_version = "2.0.0-beta.21+1.21-fabric"
val yacl_version = "3.6.2+1.21-fabric"
