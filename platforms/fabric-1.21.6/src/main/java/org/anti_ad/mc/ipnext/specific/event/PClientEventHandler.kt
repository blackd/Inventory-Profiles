...
import org.anti_ad.mc.alias.text.ClickEventOpenUrl
        ...
        .append(Text.literal("\"Modrinth\"")
                    .apply {
                        style = Style.EMPTY
                            ...
                            .withColor(Formatting.DARK_GREEN)
                            .withUnderline(true)
                            .withClickEvent(ClickEventOpenUrl(URI("https://modrinth.com/mod/inventory-profiles-next")))
        ...
        .append(Text.literal("\"CurseForge\"")
                    .apply {
                        style = Style.EMPTY
                            ...
                            .withUnderline(true)
                            .withClickEvent(ClickEventOpenUrl(URI("https://www.curseforge.com/minecraft/mc-mods/inventory-profiles-next")))
