...
object AutoRefillHandler {
    fun pressingDropKey(): Boolean {
        return Vanilla.mc().options.keyDrop.isDown // options.keyDrop.isDown = forge gameSettings.keyBindDrop.isKeyDown
    }
                        ...
                        is ArmorItem -> {
                            filtered = filtered.filter {
                                ...
                                otherType.item is ArmorItem
                                        && otherType.item.slot  == itemType.item.slot // slot = forge equipmentSlot
                            }
                        }
                        is SwordItem -> {
