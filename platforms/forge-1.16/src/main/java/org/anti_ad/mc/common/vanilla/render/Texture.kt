...
fun rDrawSprite(sprite: Sprite,
                location: Point) = rDrawSprite(sprite,
                                               0,
                                               location.x,
                                               location.y)
...
private val rVanillaButtonSpriteF = Sprite(VANILLA_TEXTURE_WIDGETS,
                                           Rectangle(0,
                                                     46,
                                                     200,
                                                     20))
val rVanillaButtonSprite = DynamicSizeSprite(rVanillaButtonSpriteF,
                                             3)
