...
object VanillaScreenUtil: IVanillaScreenUtil {
    override fun closeScreen() = Vanilla.mc().openScreen(null)
    override fun openScreen(screen: IScreenMarker) = Vanilla.mc().openScreen(screen as Screen)
    override fun openScreenNullable(screen: IScreenMarker?) = Vanilla.mc().openScreen(screen as Screen)
    ...
    override fun closeScreenGracefully() {
        ...
        Vanilla.mc().openScreen(null)
    }

}

fun openScreenNullable(screen: Screen?) {
    Vanilla.mc().openScreen(screen)
}
