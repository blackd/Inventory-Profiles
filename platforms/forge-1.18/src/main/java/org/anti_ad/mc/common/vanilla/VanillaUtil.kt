...
private object VanillaUtil: IVanillaUtil {
    ...
    override fun languageCode(): String = Vanilla.languageManager().selected.code // currentLanguage.code
    ...
    override fun mouseXRaw(): Double = Vanilla.mouse().xpos()  //mouseX
    override fun mouseYRaw(): Double = Vanilla.mouse().ypos() //mouseY
