...
object KeyCodes {
  ...
  fun getName(keyCode: Int): String {
    return MAP_KEY_CODE_TO_NAME.getOrDefault(keyCode, "keycode $keyCode")
  }

  fun getKeyCode(name: String): Int {
    return MAP_NAME_TO_KEY_CODE.getOrDefault(name, -1)
  }

  fun getFriendlyName(name: String): String {
    return MAP_NAME_TO_DISPLAY_TEXT.getOrDefault(name, name)
  }
  ...
  private fun addEntry(name: String, displayText: String?, keyCode: Int) {
    MAP_KEY_CODE_TO_NAME.getOrPut(keyCode, { name })
    MAP_NAME_TO_KEY_CODE.getOrPut(name, { keyCode })
  ...
  init {
    ...
    addEntry("COMMA"        , ","             , KEY_COMMA)
    addEntry("MINUS"        , "-"             , KEY_MINUS)
    addEntry("PERIOD"       , "."             , KEY_PERIOD)
    addEntry("SLASH"        , "/"             , KEY_SLASH)
    addEntry("0"            , "0"             , KEY_0)
    addEntry("1"            , "1"             , KEY_1)
    addEntry("2"            , "2"             , KEY_2)
    addEntry("3"            , "3"             , KEY_3)
    ...
    addEntry("8"            , "8"             , KEY_8)
    addEntry("9"            , "9"             , KEY_9)
    addEntry("SEMICOLON"    , ";"             , KEY_SEMICOLON)
    addEntry("EQUAL"        , "="             , KEY_EQUAL)
    addEntry("A"            , "a"             , KEY_A)
    addEntry("B"            , "b"             , KEY_B)
    addEntry("C"            , "c"             , KEY_C)
    addEntry("D"            , "d"             , KEY_D)
    ...
    addEntry("Y"            , "y"             , KEY_Y)
    addEntry("Z"            , "z"             , KEY_Z)
    addEntry("LEFT_BRACKET" , "["             , KEY_LEFT_BRACKET)
    addEntry("BACKSLASH"    , "\\"            , KEY_BACKSLASH)
    addEntry("RIGHT_BRACKET", "]"             , KEY_RIGHT_BRACKET)
    addEntry("GRAVE_ACCENT" , "`"             , KEY_GRAVE_ACCENT)
    addEntry("WORLD_1"      , null            , KEY_WORLD_1)
    addEntry("WORLD_2"      , null            , KEY_WORLD_2)
    addEntry("ESCAPE"       , "Esc"           , KEY_ESCAPE)
    addEntry("ENTER"        , "Enter"         , KEY_ENTER)
    addEntry("TAB"          , "Tab"           , KEY_TAB)
    addEntry("BACKSPACE"    , "Backspace"     , KEY_BACKSPACE)
    addEntry("INSERT"       , "Insert"        , KEY_INSERT)
    addEntry("DELETE"       , "Delete"        , KEY_DELETE)
    addEntry("RIGHT"        , "Right"         , KEY_RIGHT)
    addEntry("LEFT"         , "Left"          , KEY_LEFT)
    addEntry("DOWN"         , "Down"          , KEY_DOWN)
    addEntry("UP"           , "Up"            , KEY_UP)
    addEntry("PAGE_UP"      , "Page Up"       , KEY_PAGE_UP)
    addEntry("PAGE_DOWN"    , "Page Down"     , KEY_PAGE_DOWN)
    addEntry("HOME"         , "Home"          , KEY_HOME)
    addEntry("END"          , "End"           , KEY_END)
    addEntry("CAPS_LOCK"    , "Caps Lock"     , KEY_CAPS_LOCK)
    addEntry("SCROLL_LOCK"  , "Scroll Lock"   , KEY_SCROLL_LOCK)
    addEntry("NUM_LOCK"     , "Num Lock"      , KEY_NUM_LOCK)
    addEntry("PRINT_SCREEN" , "Print Screen"  , KEY_PRINT_SCREEN)
    addEntry("PAUSE"        , "Pause"         , KEY_PAUSE)
    addEntry("F1"           , "F1"            , KEY_F1)
    addEntry("F2"           , "F2"            , KEY_F2)
    addEntry("F3"           , "F3"            , KEY_F3)
    addEntry("F4"           , "F4"            , KEY_F4)
    addEntry("F5"           , "F5"            , KEY_F5)
    addEntry("F6"           , "F6"            , KEY_F6)
    addEntry("F7"           , "F7"            , KEY_F7)
    addEntry("F8"           , "F8"            , KEY_F8)
    addEntry("F9"           , "F9"            , KEY_F9)
    addEntry("F10"          , "F10"           , KEY_F10)
    addEntry("F11"          , "F11"           , KEY_F11)
    addEntry("F12"          , "F12"           , KEY_F12)
    addEntry("F13"          , null            , KEY_F13)
    addEntry("F14"          , null            , KEY_F14)
    addEntry("F15"          , null            , KEY_F15)
    addEntry("F16"          , null            , KEY_F16)
    addEntry("F17"          , null            , KEY_F17)
    addEntry("F18"          , null            , KEY_F18)
    addEntry("F19"          , null            , KEY_F19)
    addEntry("F20"          , null            , KEY_F20)
    addEntry("F21"          , null            , KEY_F21)
    addEntry("F22"          , null            , KEY_F22)
    addEntry("F23"          , null            , KEY_F23)
    addEntry("F24"          , null            , KEY_F24)
    addEntry("F25"          , null            , KEY_F25)
    addEntry("KP_0"         , "Numpad 0"      , KEY_KP_0)
    addEntry("KP_1"         , "Numpad 1"      , KEY_KP_1)
    addEntry("KP_2"         , "Numpad 2"      , KEY_KP_2)
    addEntry("KP_3"         , "Numpad 3"      , KEY_KP_3)
    addEntry("KP_4"         , "Numpad 4"      , KEY_KP_4)
    addEntry("KP_5"         , "Numpad 5"      , KEY_KP_5)
    addEntry("KP_6"         , "Numpad 6"      , KEY_KP_6)
    addEntry("KP_7"         , "Numpad 7"      , KEY_KP_7)
    addEntry("KP_8"         , "Numpad 8"      , KEY_KP_8)
    addEntry("KP_9"         , "Numpad 9"      , KEY_KP_9)
    addEntry("KP_DECIMAL"   , "Numpad ."      , KEY_KP_DECIMAL)
    addEntry("KP_DIVIDE"    , "Numpad /"      , KEY_KP_DIVIDE)
    addEntry("KP_MULTIPLY"  , "Numpad *"      , KEY_KP_MULTIPLY)
    addEntry("KP_SUBTRACT"  , "Numpad -"      , KEY_KP_SUBTRACT)
    addEntry("KP_ADD"       , "Numpad +"      , KEY_KP_ADD)
    addEntry("KP_ENTER"     , "Numpad Enter"  , KEY_KP_ENTER)
    addEntry("KP_EQUAL"     , null            , KEY_KP_EQUAL)
    addEntry("LEFT_SHIFT"   , "Left Shift"    , KEY_LEFT_SHIFT)
    addEntry("LEFT_CONTROL" , "Left Ctrl"     , KEY_LEFT_CONTROL)
    addEntry("LEFT_ALT"     , "Left Alt"      , KEY_LEFT_ALT)
    addEntry("LEFT_SUPER"   , "Left Win"      , KEY_LEFT_SUPER)
    addEntry("RIGHT_SHIFT"  , "Right Shift"   , KEY_RIGHT_SHIFT)
    addEntry("RIGHT_CONTROL", "Right Ctrl"    , KEY_RIGHT_CONTROL)
    addEntry("RIGHT_ALT"    , "Right Alt"     , KEY_RIGHT_ALT)
    addEntry("RIGHT_SUPER"  , "Right Win"     , KEY_RIGHT_SUPER)
    addEntry("MENU"         , "Menu"          , KEY_MENU)
    addEntry("LAST"         , null            , KEY_LAST)
    addEntry("BUTTON_1"     , "Left Button"   , MOUSE_BUTTON_1)
    addEntry("BUTTON_2"     , "Right Button"  , MOUSE_BUTTON_2)
    addEntry("BUTTON_3"     , "Middle Button" , MOUSE_BUTTON_3)
    addEntry("BUTTON_4"     , "Back Button"   , MOUSE_BUTTON_4)
    addEntry("BUTTON_5"     , "Forward Button", MOUSE_BUTTON_5)
