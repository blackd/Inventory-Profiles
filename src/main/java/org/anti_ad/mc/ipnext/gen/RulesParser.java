...
public class RulesParser extends Parser {
    ...
    public static class HeadContext extends ParserRuleContext {
        public TerminalNode AT() {
            return getToken(RulesParser.AT, 0);
        }

        public TerminalNode RuleName() {
            return getToken(RulesParser.RuleName, 0);
        }
    ...
    public static class SubRuleContext extends ParserRuleContext {
        ...
        public TerminalNode REVERSE() {
            return getToken(RulesParser.REVERSE, 0);
        }
    ...
    public static class SubRuleIdentifierContext extends ParserRuleContext {
        ...
        public TerminalNode DOUBLE_COLON() {
            return getToken(RulesParser.DOUBLE_COLON, 0);
        }

        public TerminalNode NamespacedId() {
            return getToken(RulesParser.NamespacedId, 0);
        }

        public TerminalNode HASHTAG() {
            return getToken(RulesParser.HASHTAG, 0);
        }

        public TerminalNode NBT() {
            return getToken(RulesParser.NBT, 0);
        }
    ...
    public static class ArgumentsContext extends ParserRuleContext {
        public TerminalNode OPEN() {
            return getToken(RulesParser.OPEN, 0);
        }
        ...
        public TerminalNode CLOSE() {
            return getToken(RulesParser.CLOSE, 0);
        }

        public List<TerminalNode> COMMA() {
            return getTokens(RulesParser.COMMA);
        }
    ...
    public static class PairContext extends ParserRuleContext {
        public TerminalNode Parameter() {
            return getToken(RulesParser.Parameter, 0);
        }

        public TerminalNode EQUAL() {
            return getToken(RulesParser.EQUAL, 0);
        }

        public TerminalNode Argument() {
            return getToken(RulesParser.Argument, 0);
        }
