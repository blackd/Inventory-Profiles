...
fun <T> T.selfIfEquals(value: T,
                       elseValue: T) = selfIfEquals(value) { elseValue }

inline fun <T> T.selfIfEquals(value: T,
                              elseValue: T.() -> T): T =
    if (this == value) this else elseValue()

fun <T> T.selfIfNotEquals(value: T,
                          elseValue: T) = selfIfNotEquals(value) { elseValue }

inline fun <T> T.selfIfNotEquals(value: T,
                                 elseValue: T.() -> T): T =
    if (this != value) this else elseValue()
