...
/**
 * This class was copied from https://github.com/swiftzer/semver/blob/master/src/main/java/net/swiftzer/semver/SemVer.kt
 *
 ...
 */
data class SemVer(val major: Int = 0,
                  val minor: Int = 0,
                  val patch: Int = 0,
                  val preRelease: String? = null,
                  val buildMetadata: String? = null) : Comparable<SemVer> {
    companion object {
        /**
    ...
    init {
        require(major >= 0) { "Major version must be a positive number or zero" }
        require(minor >= 0) { "Minor version must be a positive number or zero" }
        require(patch >= 0) { "Patch version must be a positive number or zero" }
